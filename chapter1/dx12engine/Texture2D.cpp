...
Texture2D::Texture2D(Core* core, ID3D12Resource* buffer)
{
	m_core = core;
	m_pResource = buffer;
...
{
	ID3D12Resource* buff = GetDefaultResource(core, 4, 4);
...
ID3D12Resource* Texture2D::GetDefaultResource(Core* core, size_t width, size_t height)
{
